...
```text
Nuitka_Output\CodeLazy_V0.1.7.exe
```
...
GitHub root 只保留目前最新版 V0.1.7 的程式與文件。舊版完整來源收在 `history/Vx.y.z/`，索引見 `history/README.md`。
